...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>5</td>
      <td>Canvas</td>
      <td>Displays selected UNS information or modules generated through the chat on the right.</td>
      </tr>
      <tr>
      <td>6</td>
      <td>Chat</td>
      <td>Use natural language to interact with UNS topics, and the flow generated from the chat will be displayed on the canvas.</td>
      </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
  <tr>
      <td><strong>Use mock data</strong></td>
